...
class PlaylistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create playlist" do
    assert_difference("Playlist.count") do
      post playlists_url, params: { playlist: { Album: @playlist.Album, Singer: @playlist.Singer, Song: @playlist.Song, year: @playlist.year } }
    end
  ...
  test "should update playlist" do
    patch playlist_url(@playlist), params: { playlist: { Album: @playlist.Album, Singer: @playlist.Singer, Song: @playlist.Song, year: @playlist.year } }
